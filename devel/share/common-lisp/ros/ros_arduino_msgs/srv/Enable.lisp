...
(cl:defmethod cl:initialize-instance :after ((m <Enable-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Enable-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_arduino_msgs-srv:<Enable-request> is deprecated: use ros_arduino_msgs-srv:Enable-request instead.")))

(cl:ensure-generic-function 'enable-val :lambda-list '(m))
(cl:defmethod enable-val ((m <Enable-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_arduino_msgs-srv:enable-val is deprecated.  Use ros_arduino_msgs-srv:enable instead.")
  (enable m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Enable-request>)))
  ...
  "ros_arduino_msgs/EnableRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Enable-request)))
  "Returns string type for a service object of type 'Enable-request"
  "ros_arduino_msgs/EnableRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <Enable-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Enable-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_arduino_msgs-srv:<Enable-response> is deprecated: use ros_arduino_msgs-srv:Enable-response instead.")))

(cl:ensure-generic-function 'state-val :lambda-list '(m))
(cl:defmethod state-val ((m <Enable-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_arduino_msgs-srv:state-val is deprecated.  Use ros_arduino_msgs-srv:state instead.")
  (state m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Enable-response>)))
  ...
  "ros_arduino_msgs/EnableResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Enable-response)))
  "Returns string type for a service object of type 'Enable-response"
  "ros_arduino_msgs/EnableResponse")
