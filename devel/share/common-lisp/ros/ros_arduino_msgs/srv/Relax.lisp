...
(cl:defmethod cl:initialize-instance :after ((m <Relax-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Relax-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_arduino_msgs-srv:<Relax-request> is deprecated: use ros_arduino_msgs-srv:Relax-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <Relax-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Relax-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_arduino_msgs-srv:<Relax-response> is deprecated: use ros_arduino_msgs-srv:Relax-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Relax-response>)))
  ...
  "ros_arduino_msgs/RelaxResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Relax-response)))
  "Returns string type for a service object of type 'Relax-response"
  "ros_arduino_msgs/RelaxResponse")
